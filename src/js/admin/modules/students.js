    ...
    html(grid, this.students.map(s => `
      <div class="student-card">
        ...
        <div class="student-actions">
          <button class="edit-btn" onclick="window.dashboard.modules.students.edit('${s.id}')">
            <i class="fas fa-edit"></i> Editar
          </button>
          <button class="delete-btn" onclick="window.dashboard.modules.students.delete('${s.id}')">
